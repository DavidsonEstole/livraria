...
<?php
    function imprimir2(){
    include 'conection.php';
 $result = mysqli_query($conn, "SELECT * FROM livro WHERE quantidade < 20 ORDER BY quantidade DESC");

 echo  '<ul class="list-group">
  <li class="list-group-item"><div class="col-sm-2">Nome</div><div class="col-sm-2">Quantidade</div><div class="col-sm-2">ID</div><div class="col-sm-2">Editar</div><div class="col-sm-2">Excluir</div>
  </li>';
...
if($result === FALSE) { 
    ...
    foreach( $result as $row ) {
        ...
        echo 
  "<li class='list-group-item'><div class='col-sm-2'>" .$row['NOME']. "</div><div class='col-sm-2'>" .$row['quantidade']. "</div><div class='col-sm-2'>" .$row['ID']. "</div>
  <div class='col-sm-2'><a href='edit_livro.php?livro= + " .$row['ID']. "'><span class='glyphicon glyphicon-edit'></span></a></div><div class='col-sm-3'><a href='excluir_livro.php?id= + " .$row['ID']. "'><span style='color: #FD0004' class='glyphicon glyphicon-remove'></span></a></div></li>";
    }
}
echo "</ul>";
    }
