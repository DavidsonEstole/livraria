...
<?php } ?>
    ...
    <form class="form-horizontal" role="form" action="database_livro.php" enctype="multipart/form-data" method="post">
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <textarea type="text" class="form-control" rows="5" name="descricao" required></textarea>
    </div>
